...
- Projekt: **TMS-deploy-ready** (KED Global Logistics)
- Stack: Backend (NestJS) auf Railway, Frontend auf Vercel, Postgres auf Railway
- Aktiver Entwicklungs-Branch: `claude/resume-tms-deploy-DDF1n`
